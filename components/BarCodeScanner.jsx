...
const CROP_SIZE_FACTOR = 0.5;

export default function BarCodeSanner() {
    ...
    <div className="flex flex-col items-center p-4 font-sans">
      ...
      {scanning ? (
        <>
          ...
          <div className="relative aspect-square w-full max-w-sm overflow-hidden rounded-xl border border-gray-300 shadow-lg">
            <video
              ref={videoRef}
              autoPlay
              playsInline
          ...
          <canvas
            ...
            className="block h-30 w-50 rounded-md border-2 border-blue-500 shadow-md"
          >
